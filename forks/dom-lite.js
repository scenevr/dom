...
Node.prototype = {
  ...
  get style() {
    if(!this.styleMap){
      ...
      Object.observe(this.styleMap, this.markAsDirty.bind(this));
    }
  ...
  removeChild: function(el) {
    ...
    // more hacks - mark this node as dirty if it's content changed
    if(this.nodeName != "scene"){
      this.markAsDirty();
    }
  ...
  cloneNode: function(deep) {
    // todo - strip uuid off cloned node
